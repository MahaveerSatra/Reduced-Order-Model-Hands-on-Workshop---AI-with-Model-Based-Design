###########################################################################
## Makefile generated for component 'PMSM_ROM_NSS_CodeGeneration'. 
## 
## Makefile     : PMSM_ROM_NSS_CodeGeneration.mk
## Generated on : Tue May 06 12:58:03 2025
## Final product: .\PMSM_ROM_NSS_CodeGeneration.exe
...
PRODUCT_NAME              = PMSM_ROM_NSS_CodeGeneration
MAKEFILE                  = PMSM_ROM_NSS_CodeGeneration.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Mahaveer\Examples\AI0552~1\ROMOFA~1\Models
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
MODELREF_LINK_RSPFILE     = PMSM_ROM_NSS_CodeGeneration_ref.rsp
COMPILER_COMMAND_FILE     = PMSM_ROM_NSS_CodeGeneration_comp.rsp
CMD_FILE                  = PMSM_ROM_NSS_CodeGeneration.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = .\PMSM_ROM_NSS_CodeGeneration.exe
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=0 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=50000 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=50000 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
DEFINES_STANDARD = -DMODEL=PMSM_ROM_NSS_CodeGeneration -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = xil_interface.obj sil_main.obj rtiostream_tcpip.obj xil_interface_lib.obj xil_data_stream.obj xil_services.obj xilcomms_rtiostream.obj xil_rtiostream.obj rtiostream_utils.obj target_io.obj coder_assumptions_app.obj coder_assumptions_data_stream.obj coder_assumptions_rtiostream.obj xil_instrumentation.obj codeinstr_data_stream.obj codeinstr_rtiostream.obj host_timer_x86.obj
...
MODELREF_LIBS = ..\instrumented\PMSM_ROM_NSS_CodeGeneration.obj ..\instrumented\PMSM_ROM_NSS_CodeGeneration_data.obj

LIBS = $(START_DIR)\PMSM_ROM_NSS_CodeGeneration_ert_rtw\coderassumptions\lib\PMSM_ROM_NSS_CodeGeneration_ca.lib
...
xil_interface.obj : "$(START_DIR)\PMSM_ROM_NSS_CodeGeneration_ert_rtw\sil\xil_interface.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PMSM_ROM_NSS_CodeGeneration_ert_rtw\sil\xil_interface.c"


sil_main.obj : "$(START_DIR)\PMSM_ROM_NSS_CodeGeneration_ert_rtw\sil\sil_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PMSM_ROM_NSS_CodeGeneration_ert_rtw\sil\sil_main.c"
...
xil_instrumentation.obj : "$(START_DIR)\PMSM_ROM_NSS_CodeGeneration_ert_rtw\sil\xil_instrumentation.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PMSM_ROM_NSS_CodeGeneration_ert_rtw\sil\xil_instrumentation.c"
