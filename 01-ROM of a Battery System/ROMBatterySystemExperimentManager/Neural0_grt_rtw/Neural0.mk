###########################################################################
## Makefile generated for component 'Neural0'. 
## 
## Makefile     : Neural0.mk
## Generated on : Mon Apr 28 14:44:50 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Neural0.exe
...
COMPILER_COMMAND_FILE     = Neural0_comp.rsp
CMD_FILE                  = Neural0.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Neural0.exe
...
DEFINES_STANDARD = -DMODEL=Neural0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\Neural0_grt_rtw\Neural0.c $(START_DIR)\Neural0_grt_rtw\Neural0_data.c $(START_DIR)\Neural0_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj Neural0.obj Neural0_data.obj rt_nonfinite.obj
...
{$(START_DIR)\Neural0_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Neural0_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Neural0_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Neural0_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Neural0.obj : "$(START_DIR)\Neural0_grt_rtw\Neural0.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Neural0_grt_rtw\Neural0.c"


Neural0_data.obj : "$(START_DIR)\Neural0_grt_rtw\Neural0_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Neural0_grt_rtw\Neural0_data.c"


rt_nonfinite.obj : "$(START_DIR)\Neural0_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Neural0_grt_rtw\rt_nonfinite.c"
